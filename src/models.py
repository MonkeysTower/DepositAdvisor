...
def find_best_deposit(row, deposits):
    ...
    filtered_deposits = deposits[
        (row['Срок вклада'] >= deposits['Минимальный срок']) | (deposits['Минимальный срок'].isna() &
        (row['Срок вклада'] <= deposits['Максимальный срок']) | (deposits['Максимальный срок'].isna() &
        (row['Сумма вклада'] >= deposits['Минимальная сумма']) | (deposits['Минимальная сумма'].isna() &
        (row['Сумма вклада'] <= deposits['Максимальная сумма']) | (deposits['Максимальная сумма'].isna() &
